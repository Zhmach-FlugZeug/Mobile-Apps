...
/** @hide */
	...
	public RefreshHandler (android.os.Handler.Callback p0)
	{
		super (p0);
		if (getClass () == RefreshHandler.class)
			mono.android.TypeManager.Activate ("Mono.Samples.Snake.RefreshHandler, Snake", "Android.OS.Handler+ICallback, Mono.Android", this, new java.lang.Object[] { p0 });
	}
	...
	public RefreshHandler (android.os.Looper p0, android.os.Handler.Callback p1)
	{
		super (p0, p1);
		if (getClass () == RefreshHandler.class)
			mono.android.TypeManager.Activate ("Mono.Samples.Snake.RefreshHandler, Snake", "Android.OS.Looper, Mono.Android:Android.OS.Handler+ICallback, Mono.Android", this, new java.lang.Object[] { p0, p1 });
	}
